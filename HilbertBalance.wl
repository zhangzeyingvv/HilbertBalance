...
HilbertBases::usage = "Get the symmetried Hamiltonian in convenition I"
...
HilbertBases[Null_]:=Module[{Hilb,Hilb2,res,sign},
  ...
  sign=RunProcess[{"cmd","/c",NormalizPath<>" "<>FileNameJoin[{$TemporaryDirectory,"5.in"}]<>"/t"}];
  ...
  sign=RunProcess[{"cmd","/c",NormalizPath<>" "<>FileNameJoin[{$TemporaryDirectory,"6.in"}]<>"/t"}];
...
balanceMatrix[chem_, OptionsPattern[]]:=Module[
    {parts,compounds,elements,balenceM,occ,npart,null,hilb,l,s,t,ll,res,
